...
public class SFTPUtils {
    ...
    private static transient org.slf4j.Logger LOG = LoggerFactory.getLogger(SFTPUtils.class);

    private static final String host = "118.184.217.230";
    private static final int port = 22;
    private static final String username = "root";
    private static final String password = "zzq,.7727986";
    public static final String directory = "/usr/local/file/image";
